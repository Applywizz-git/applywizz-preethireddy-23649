...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: 'Email', value: 'preethi.reddy.rav@gmail.com', href: 'mailto:preethi.reddy.rav@gmail.com' },
    { icon: Phone, label: 'Phone', value: '+1 (470) 747-2860', href: 'tel:+14707472860' },
    { icon: MapPin, label: 'Location', value: 'Aubrey, TX', href: null },
  ];
