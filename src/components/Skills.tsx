...
const Skills = () => {
  ...
  const topSkills = [
    { name: 'Cloud Data Engineering', level: 95, color: 'hsl(var(--accent))' },
    { name: 'Distributed Processing (Spark)', level: 92, color: 'hsl(var(--accent-secondary))' },
    { name: 'Workflow Orchestration', level: 90, color: 'hsl(var(--accent))' },
    { name: 'Lakehouse Architecture', level: 88, color: 'hsl(var(--accent-secondary))' },
  ];

  const skillCategories = [
    {
      title: 'Cloud Platforms',
      skills: ['AWS (Glue, EMR, Athena)', 'Azure (ADF, Synapse)', 'Databricks', 'S3 / ADLS Gen2', 'Lambda', 'Snowflake'],
    },
    {
      title: 'Data Processing',
      skills: ['Python', 'PySpark', 'Apache Spark', 'SQL', 'ETL / ELT', 'Batch & Streaming'],
    },
    {
      title: 'Architecture & Streaming',
      skills: ['Lakehouse', 'Apache Iceberg', 'Apache Kafka', 'Event Hub', 'Medallion Architecture', 'Data Modeling'],
    },
    {
      title: 'DevOps & DataOps',
      skills: ['Terraform', 'Airflow', 'Docker', 'Git', 'CI/CD Pipelines', 'Splunk / DynaTrace'],
    },
  ];
